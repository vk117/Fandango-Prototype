...
class Dashboard extends React.Component {
  ...
  state = { projects : [] , projects1: [] } 
   ...
   search = (e) => {
     e.preventDefault();
      ...
      var filter = { s : this.searchform.querySelector('.s').value, bid_winner : true  };
  ...
  search1 = (e) => {
     e.preventDefault();
      ...
      var filter = { s : this.searchform1.querySelector('.s').value  };
  ...
  createItem = (t,i) => {
     ...
     var slug = '/projects/'+t.slug; 
      ...
      if(typeof t.winner_id === "undefined") 
        return null;
          ...
          if( t.winner_id.avatar === ""){
            ...
            avatar = <img alt="avatar" src={"/uploads/"+t.winner_id.avatar} className="avatar avatar-lg mr-3" />
          }
 ...
 createItem1 = (t,i) => {
     ...
     var slug = '/projects/'+t.slug; 
      ...
      var avatar;
      if(typeof t.owner.avatar === "undefined" || t.owner.avatar === ""){
        avatar = <span className="avatar bg-purple">{t.owner.first_name[0]}{t.owner.last_name[0]}</span>
      } else {
        avatar = <img alt="avatar" src={"/uploads/"+t.owner.avatar} className="avatar avatar-lg mr-3" />
      }
                  ...
                  <div className="page-content no-banner">
                      ...
                      <div className="container">
                          ...
                          <div className="fr-widget-body">
                              ...
                              <form ref={(f) => {this.searchform1 = f;} } onSubmit={this.search1} action="">
                                    <div className="input-group">
                                        <input type="text" className="form-control s" placeholder="Search by name or skills" aria-label="Search by name or skills" aria-describedby="basic-addon2" />
                                        <div className="input-group-append">
                                            <button className="btn btn-primary" type="submit">Search</button>
