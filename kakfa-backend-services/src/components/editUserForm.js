    ...
    <button type="button" className="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
                ...
                <div className="row">
                                  ...
                                  <div className="row">    
                                  <div className="col">    
                                  <button type="submit" className='btn'>Register <i className="fas fa-angle-right"></i></button>
                                  </div>
                                  </div>
                                             ...
                                             <div className="dropzon-wrap">
                                                <div className="dropzone">
                                                  <Dropzone  onDrop={this.onDrop.bind(this)} name="file" style={{}} accept=".jpg,.png">
                                                   ...
                                                   <img ref={ (el) => {this.image = el;} } src={"http://localhost:3000/uploads/"+u.avatar} alt=""/>
                                             </div>
